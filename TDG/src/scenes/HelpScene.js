...
const HTP_SECTIONS = [
  {
    ...
    lines: [
      ...
      'Bow          — Auto-fires every 2s (no key needed) if bow is equipped · upgrades to Ruby/Emerald Bow',
  ...
  },
  {
    ...
    lines: [
      ...
      '  Ruby Bow — 0.8s fire rate · 15 dmg  fast (requires Bow)',
      '    Cost: 2 ruby + 8 bone + 3 iron',
      '  Emerald Bow — 3s fire rate · 45 dmg  heavy (requires Bow)',
      '    Cost: 2 emerald + 8 bone + 3 crystal',
